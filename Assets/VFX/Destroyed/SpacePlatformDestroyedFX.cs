...
public class SpacePlatformDestroyedFX: MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        {
            spacePlatformGroup.OnDestroyed += PlayVFX;
        }
        else
        {
    ...
    {
        if (spacePlatformGroup != null) spacePlatformGroup.OnDestroyed -= PlayVFX;
    }
}
